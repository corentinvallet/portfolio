...
/* =====================================================================
   ...
   INSTALLATION
   1. Déposez ce fichier dans le dossier admin/ du site (même dossier que
      admin/index.html), via le Gestionnaire de fichiers Hostinger.
   2. Changez la valeur de $ADMIN_TOKEN ci-dessous (un mot de passe libre).
   3. Dans config.js (à la racine du site) mettez :
...
$ADMIN_TOKEN = 'CHANGEZ-MOI-abri-libellules-2026';
