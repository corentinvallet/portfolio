...
<nav id="main-nav">
  ...
  <ul class="nav-links" id="nav-home-links">
    <li><a onclick="showPage('home');scrollToSection('services')">Services</a></li>
    <li><a onclick="showPage('home');scrollToSection('realisations')">Réalisations</a></li>
    <li><a onclick="showPage('home');scrollToSection('process')">Méthode</a></li>
    <li><a onclick="showPage('home');scrollToSection('about')">À propos</a></li>
    <li><a onclick="showPage('home');scrollToSection('contact')">Contact</a></li>
  </ul>
  <button class="nav-back" id="nav-gallery-back" style="display:none" onclick="showPage('home')">
...
<div id="page-home" class="page active">
  ...
  <!-- CAVE A VIN -->
  <section id="caveavin">
    <div class="caveavin-text">
      <p class="section-label"><?= e($cave['label'] ?? '') ?></p>
      <h2 class="section-title"><?= ml($cave['title'] ?? '') ?></h2>
      <p class="section-desc" style="max-width:470px"><?= e($cave['p1'] ?? '') ?></p>
      <p class="section-desc" style="max-width:470px;margin-top:14px"><?= e($cave['p2'] ?? '') ?></p>
      <div class="caveavin-names">
        <?php foreach (($cave['tags'] ?? []) as $tag): ?>
        <div class="caveavin-name-card"><strong><?= e($tag) ?></strong></div>
        <?php endforeach; ?>
      </div>
    </div>
    <div class="caveavin-img-wrap">
      <img src="<?= e($cave['image'] ?? '') ?>" loading="lazy" alt="Cave à vin sur mesure">
      <?php $cb = $cave['badge'] ?? ''; $cbp = explode(' ', $cb, 2); ?>
      <div class="caveavin-badge"><?= e($cbp[0] ?? '') ?> <br/><strong><?= e($cbp[1] ?? '') ?></strong></div>
    </div>
  </section>
  ...
  <section id="realisations">
    ...
    <a class="gallery-link-banner" onclick="showPage('gallery')">
  ...
  <section id="about">
    ...
    <div class="about-text">
      ...
      <p class="section-desc" style="color:rgba(232,220,200,.72);max-width:470px"><?= e($about['p1'] ?? '') ?></p>
      <p class="section-desc" style="color:rgba(232,220,200,.5);max-width:470px;margin-top:14px;font-size:.9rem"><?= e($about['p2'] ?? '') ?></p>
...
<div id="page-gallery" class="page">
  ...
  <div class="gallery-section">
    <div class="gallery-filters">
      ...
      <button class="filter-btn" data-filter="cave-a-vin">Caves à vins</button>
      <button class="filter-btn" data-filter="beton-cire">Béton ciré</button>
      <button class="filter-btn" data-filter="beton-desactive">Béton désactivé</button>
      <button class="filter-btn" data-filter="piscine">Piscine</button>
      <button class="filter-btn" data-filter="beton-imprime">Béton imprimé</button>
    </div>
...
<!-- ═══════════════════════════════════════════
     LIGHTBOX (commune aux deux pages)
═══════════════════════════════════════════ -->
...
function showPage(name) {
  ...
  document.getElementById('nav-home-links').style.display = isGallery ? 'none' : '';
  document.getElementById('nav-gallery-back').style.display = isGallery ? '' : 'none';
}
