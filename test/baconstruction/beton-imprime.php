...
$galleryCats = ['beton-cire', 'beton-imprime', 'beton-desactive', 'enduit-décoratif'];
$gallery = array_values(array_filter($c['gallery'] ?? [], fn($g) => array_intersect($galleryCats, $g['categories'] ?? ($g['category'] ? [$g['category']] : [])), true));
