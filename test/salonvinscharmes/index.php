...
<title><?= e($c['meta']['title'] ?? 'Salon des vins de France') ?></title>
...
<link rel="stylesheet" href="assets/page-carte.css?v=<?= @filemtime(__DIR__ . '/assets/page-carte.css') ?: time() ?>">
<?php if ($heroDesktop !== ''): ?>
...
<style>
  ...
  .carte-mention{
    ...
    font-family:'Fraunces',Georgia,serif;font-style:italic;color:var(--paper);
  }
...
<script src="assets/script-carte.js" defer></script>
...
<script>
  ...
  (function() {
    var u="//www.corentinvallet.fr/test/salonvinscharmes/analytics/matomo-latest/matomo/";
