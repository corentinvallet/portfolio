...
class __TwigTemplate_7afec2259a9dbeb1bc6827c2cbb42868 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_sparklineEvolution($__evolution__ = null, ...$__varargs__)
    {
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (((isset($context["compareValue"]) || array_key_exists("compareValue", $context) ? $context["compareValue"] : (function () { throw new RuntimeError('Variable "compareValue" does not exist.', 6, $this->source); })()) < 0)) {
                ...
                // line 8
                yield "        ";
                $context["evolutionIcon"] = (((isset($context["isLowerValueBetter"]) || array_key_exists("isLowerValueBetter", $context) ? $context["isLowerValueBetter"] : (function () { throw new RuntimeError('Variable "isLowerValueBetter" does not exist.', 8, $this->source); })())) ? ("arrow_down_green.svg") : ("arrow_down.svg"));
                // line 9
                yield "    ";
                ...
                // line 11
                yield "        ";
                $context["evolutionIcon"] = "stop.svg";
                // line 12
                yield "    ";
            } else {
                // line 13
                ...
                // line 14
                yield "        ";
                $context["evolutionIcon"] = (((isset($context["isLowerValueBetter"]) || array_key_exists("isLowerValueBetter", $context) ? $context["isLowerValueBetter"] : (function () { throw new RuntimeError('Variable "isLowerValueBetter" does not exist.', 14, $this->source); })())) ? ("arrow_up_red.svg") : ("arrow_up.svg"));
                // line 15
                yield "        ";
...
\t<div>
        ";
            ...
            foreach ($context['_seq'] as $context["groupName"] => $context["group"]) {
                ...
                ";
                    ...
                    if (CoreExtension::inFilter("%s", CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "description", [], "any", false, false, false, 40))) {
                        // line 41
                        $context["descriptionParts"] = Twig\Extension\CoreExtension::split($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "description", [], "any", false, false, false, 41), "%s", 2);
                        // line 42
                        yield \Piwik\piwik_escape_filter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["descriptionParts"]) || array_key_exists("descriptionParts", $context) ? $context["descriptionParts"] : (function () { throw new RuntimeError('Variable "descriptionParts" does not exist.', 42, $this->source); })()), 0, [], "array", false, false, false, 42), "html", null, true);
                        yield "<strong>";
                        yield \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('number')->getCallable()(CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "value", [], "any", false, false, false, 42), 2), "html", null, true);
                        yield "</strong>";
                        yield \Piwik\piwik_escape_filter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["descriptionParts"]) || array_key_exists("descriptionParts", $context) ? $context["descriptionParts"] : (function () { throw new RuntimeError('Variable "descriptionParts" does not exist.', 42, $this->source); })()), 1, [], "array", false, false, false, 42), "html", null, true);
                    } else {
                        // line 44
                        yield "                    <strong>";
                        yield \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('number')->getCallable()(CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "value", [], "any", false, false, false, 44), 2), "html", null, true);
                        yield "</strong> ";
                        yield \Piwik\piwik_escape_filter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "description", [], "any", false, false, false, 44), "html", null, true);
                    }
                    // line 45
                ...
                ";
                    // line 47
                    if (CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "evolution", [], "any", true, true, false, 47)) {
                        // line 48
                        yield "                    ";
                        yield CoreExtension::callMacro($macros["_self"], "macro_sparklineEvolution", [CoreExtension::getAttribute($this->env, $this->source, $context["metric"], "evolution", [], "any", false, false, false, 48)], 48, $context, $this->getSourceContext());
                        yield "
                ";
                    }
                    // line 50
            ...
            // line 52
            yield "        ";
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["sparkline"] ?? null), "evolution", [], "any", true, true, false, 52)) {
                // line 53
                yield "            ";
                yield CoreExtension::callMacro($macros["_self"], "macro_sparklineEvolution", [CoreExtension::getAttribute($this->env, $this->source, (isset($context["sparkline"]) || array_key_exists("sparkline", $context) ? $context["sparkline"] : (function () { throw new RuntimeError('Variable "sparkline" does not exist.', 53, $this->source); })()), "evolution", [], "any", false, false, false, 53)], 53, $context, $this->getSourceContext());
                yield "
        ";
            }
            // line 55
...
";
    ...
    {
        return array (  288 => 55,  282 => 53,  279 => 52,  273 => 51,  259 => 50,  253 => 48,  251 => 47,  248 => 46,  244 => 45,  238 => 44,  231 => 42,  229 => 41,  227 => 40,  218 => 39,  200 => 38,  193 => 37,  189 => 36,  185 => 34,  180 => 33,  172 => 32,  169 => 31,  163 => 30,  159 => 28,  152 => 27,  146 => 26,  140 => 25,  137 => 24,  123 => 23,  113 => 20,  109 => 19,  105 => 18,  102 => 17,  99 => 16,  96 => 15,  93 => 14,  90 => 13,  87 => 12,  84 => 11,  81 => 10,  78 => 9,  75 => 8,  72 => 7,  69 => 6,  66 => 5,  63 => 4,  60 => 3,  48 => 2,  42 => 22,  39 => 1,);
    }
...
{% endmacro %}
", "@CoreVisualizations/macros.twig", "/home/u348430936/domains/corentinvallet.fr/public_html/test/salonvinscharmes/analytics/matomo-latest/matomo/plugins/CoreVisualizations/templates/macros.twig");
    }
}
