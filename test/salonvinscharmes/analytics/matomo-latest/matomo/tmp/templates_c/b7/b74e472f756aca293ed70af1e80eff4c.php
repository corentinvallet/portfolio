...
class __TwigTemplate_24b32182ce55c55f759fa71be8c31211 extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            ";
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, ($context["menu"] ?? null), "_attribute", [], "any", true, true, false, 19)) {
                    yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 19, $this->source); })()), "_attribute", [], "any", false, false, false, 19);
                }
                // line 20
                yield "               ";
...
<a href=\"javascript:;\" data-target=\"mobile-left-menu\" class=\"activateLeftMenu hide-on-large-only button-collapse sidenav-trigger\" style=\"display:none;\"><span class=\"icon-menu-hamburger\"></span></a>
<a href=\"javascript:;\" data-target=\"mobile-top-menu\" class=\"activateTopMenu hide-on-large-only button-collapse sidenav-trigger\"><span class=\"icon-more-verti\"></span></a>
", "@CoreHome/_topBar.twig", "/home/u348430936/domains/corentinvallet.fr/public_html/test/salonvinscharmes/analytics/matomo-latest/matomo/plugins/CoreHome/templates/_topBar.twig");
    }
}
