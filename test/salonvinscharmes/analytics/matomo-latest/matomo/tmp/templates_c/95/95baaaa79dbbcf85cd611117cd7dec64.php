...
class __TwigTemplate_35b8c10a8a55fbf1bce3dbcd0da135b4 extends Template
{
    private $source;
    private $macros = [];
    ...
    request-params=\"";
        // line 7
        yield \Piwik\piwik_escape_filter($this->env, json_encode(Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "request_parameters_to_modify", [], "any", true, true, false, 7)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "request_parameters_to_modify", [], "any", false, false, false, 7), [])) : ([])), ((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "export_parameters_to_modify", [], "any", true, true, false, 7)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "export_parameters_to_modify", [], "any", false, false, false, 7), [])) : ([])))), "html", null, true);
        yield "\"
    ...
    show-flatten-table=\"";
        ...
        yield "\"
    report-supports-flatten=\"";
        // line 17
        yield \Piwik\piwik_escape_filter($this->env, json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 17, $this->source); })()), "report_supports_flatten", [], "any", false, false, false, 17)), "html", null, true);
        yield "\"
    report-supports-percentage-values=\"";
        // line 18
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "report_supports_percentage_values", [], "any", true, true, false, 18)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "report_supports_percentage_values", [], "any", false, false, false, 18), false)) : (false))), "html", null, true);
        yield "\"
    export-supports-flatten=\"";
        // line 19
        yield \Piwik\piwik_escape_filter($this->env, json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 19, $this->source); })()), "show_flatten_table_export", [], "any", false, false, false, 19)), "html", null, true);
        yield "\"
    client-side-parameters=\"";
        // line 20
        yield \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["clientSideParameters"]) || array_key_exists("clientSideParameters", $context) ? $context["clientSideParameters"] : (function () { throw new RuntimeError('Variable "clientSideParameters" does not exist.', 20, $this->source); })())), "html", null, true);
        yield "\"
    has-multiple-dimensions=\"";
        // line 21
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("hasMultipleDimensions", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["hasMultipleDimensions"]) || array_key_exists("hasMultipleDimensions", $context) ? $context["hasMultipleDimensions"] : (function () { throw new RuntimeError('Variable "hasMultipleDimensions" does not exist.', 21, $this->source); })()), false)) : (false))), "html", null, true);
        yield "\"
    is-data-table-empty=\"";
        // line 22
        yield \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["isDataTableEmpty"]) || array_key_exists("isDataTableEmpty", $context) ? $context["isDataTableEmpty"] : (function () { throw new RuntimeError('Variable "isDataTableEmpty" does not exist.', 22, $this->source); })())), "html", null, true);
        yield "\"
    show-totals-row=\"";
        // line 23
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_totals_row", [], "any", true, true, false, 23)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_totals_row", [], "any", false, false, false, 23), false)) : (false))), "html", null, true);
        yield "\"
    show-exclude-low-population=\"";
        // line 24
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_exclude_low_population", [], "any", true, true, false, 24)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_exclude_low_population", [], "any", false, false, false, 24), false)) : (false))), "html", null, true);
        yield "\"
    show-pivot-by-subtable=\"";
        // line 25
        yield \Piwik\piwik_escape_filter($this->env, json_encode((((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_pivot_by_subtable", [], "any", true, true, false, 25)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "show_pivot_by_subtable", [], "any", false, false, false, 25), false)) : (false)) &&  !((array_key_exists("isComparing", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["isComparing"]) || array_key_exists("isComparing", $context) ? $context["isComparing"] : (function () { throw new RuntimeError('Variable "isComparing" does not exist.', 25, $this->source); })()), false)) : (false)))), "html", null, true);
        yield "\"
    show-periods=\"";
        // line 26
        yield \Piwik\piwik_escape_filter($this->env, json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 26, $this->source); })()), "show_periods", [], "any", false, false, false, 26)), "html", null, true);
        yield "\"
    translations=\"";
        // line 27
        yield \Piwik\piwik_escape_filter($this->env, json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 27, $this->source); })()), "translations", [], "any", false, false, false, 27)), "html", null, true);
        yield "\"
    view-data-table=\"";
        // line 28
        yield \Piwik\piwik_escape_filter($this->env, json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["clientSideParameters"]) || array_key_exists("clientSideParameters", $context) ? $context["clientSideParameters"] : (function () { throw new RuntimeError('Variable "clientSideParameters" does not exist.', 28, $this->source); })()), "viewDataTable", [], "any", false, false, false, 28)), "html", null, true);
        yield "\"
    pivot-dimension-name=\"";
        // line 29
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "pivot_dimension_name", [], "any", true, true, false, 29)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "pivot_dimension_name", [], "any", false, false, false, 29), null)) : (null))), "html", null, true);
        yield "\"
    selectable-periods=\"";
        // line 30
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "selectable_periods", [], "any", true, true, false, 30)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["properties"] ?? null), "selectable_periods", [], "any", false, false, false, 30), [])) : ([]))), "html", null, true);
        yield "\"
    placement=\"";
        // line 31
        yield \Piwik\piwik_escape_filter($this->env, json_encode(((array_key_exists("placement", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["placement"]) || array_key_exists("placement", $context) ? $context["placement"] : (function () { throw new RuntimeError('Variable "placement" does not exist.', 31, $this->source); })()), "footer")) : ("footer"))), "html", null, true);
        yield "\"
></div>
";
        return; yield '';
    ...
    {
        return array (  154 => 31,  150 => 30,  146 => 29,  142 => 28,  138 => 27,  134 => 26,  130 => 25,  126 => 24,  122 => 23,  118 => 22,  114 => 21,  110 => 20,  106 => 19,  102 => 18,  98 => 17,  94 => 16,  90 => 15,  86 => 14,  82 => 13,  78 => 12,  74 => 11,  70 => 10,  66 => 9,  62 => 8,  58 => 7,  54 => 6,  50 => 5,  46 => 4,  42 => 3,  38 => 1,);
    }
    ...
    report-supports-flatten=\"{{ properties.report_supports_flatten|json_encode }}\"
    report-supports-percentage-values=\"{{ properties.report_supports_percentage_values|default(false)|json_encode }}\"
    export-supports-flatten=\"{{ properties.show_flatten_table_export|json_encode }}\"
...
></div>
", "@CoreHome/_dataTableActions.twig", "/home/u348430936/domains/corentinvallet.fr/public_html/test/salonvinscharmes/analytics/matomo-latest/matomo/plugins/CoreHome/templates/_dataTableActions.twig");
    }
}
