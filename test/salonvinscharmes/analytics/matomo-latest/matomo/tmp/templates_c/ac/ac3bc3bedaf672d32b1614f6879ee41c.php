...
class __TwigTemplate_fecb283e63b03fd0e706bd194f6d2ff7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"mapWidgetStatus\">
        ...
        ";
            ...
            yield "            <span class=\"loadingPiwik\">
                ";
            // line 29
            yield from             $this->loadTemplate("@CoreHome/_loader.twig", "@UserCountryMap/visitorMap.twig", 29)->unwrap()->yield($context);
            // line 30
            yield "                ";
...
";
        ...
        if ( !(isset($context["noData"]) || array_key_exists("noData", $context) ? $context["noData"] : (function () { throw new RuntimeError('Variable "noData" does not exist.', 81, $this->source); })())) {
            // line 82
            yield "<!-- configure some matomo vars -->
...
";
    ...
    {
        return array (  210 => 88,  206 => 87,  202 => 86,  198 => 85,  193 => 82,  191 => 81,  186 => 78,  179 => 73,  168 => 71,  164 => 70,  159 => 68,  155 => 66,  140 => 64,  136 => 63,  126 => 56,  119 => 52,  112 => 50,  95 => 35,  93 => 34,  90 => 33,  83 => 30,  81 => 29,  78 => 28,  72 => 26,  66 => 24,  63 => 23,  61 => 22,  38 => 1,);
    }
...
{% endif %}
", "@UserCountryMap/visitorMap.twig", "/home/u348430936/domains/corentinvallet.fr/public_html/test/salonvinscharmes/analytics/matomo-latest/matomo/plugins/UserCountryMap/templates/visitorMap.twig");
    }
}
