...
class __TwigTemplate_8301c76518d51b0f2d81ddca654ce71c extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["dimensions"]) || array_key_exists("dimensions", $context) ? $context["dimensions"] : (function () { throw new RuntimeError('Variable "dimensions" does not exist.', 64, $this->source); })())]));
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["dataTable"]) || array_key_exists("dataTable", $context) ? $context["dataTable"] : (function () { throw new RuntimeError('Variable "dataTable" does not exist.', 76, $this->source); })()), "getTotalsRow", [], "any", false, false, false, 76) && CoreExtension::getAttribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 76, $this->source); })()), "show_totals_row", [], "any", false, false, false, 76))) {
                    ...
                    // line 79
                    yield "                ";
                    $context["isFilteredTotals"] = ((array_key_exists("isFilteredTotalsRow", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["isFilteredTotalsRow"]) || array_key_exists("isFilteredTotalsRow", $context) ? $context["isFilteredTotalsRow"] : (function () { throw new RuntimeError('Variable "isFilteredTotalsRow" does not exist.', 79, $this->source); })()), false)) : (false));
                    // line 80
                    yield "                ";
                    $context["additiveTreatment"] = Twig\Extension\CoreExtension::constant("Piwik\\Plugins\\CoreVisualizations\\Metrics\\MetricTotalsTreatment::TREATMENT_ADDITIVE");
                    // line 81
                    yield "                <tr class=\"";
                    yield \Piwik\piwik_escape_filter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 81, $this->source); })()), "getMetadata", ["css_class"], "method", false, false, false, 81), "html", null, true);
                    yield " totalsRow";
                    if ((isset($context["isFilteredTotals"]) || array_key_exists("isFilteredTotals", $context) ? $context["isFilteredTotals"] : (function () { throw new RuntimeError('Variable "isFilteredTotals" does not exist.', 81, $this->source); })())) {
                        yield " filteredTotalsRow";
                    }
                    yield "\"
                    ...
                    // line 83
                    $context['_parent'] = $context;
                    $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 83, $this->source); })()), "columns_to_display", [], "any", false, false, false, 83));
                    $context['loop'] = [
                      'parent' => $context['_parent'],
                      'index0' => 0,
                      'index'  => 1,
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                        ...
                        yield " ";
                        if (CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 84)) {
                            yield "first";
                        }
                        yield "\">
                            ";
                        // line 85
                        yield from                         $this->loadTemplate("@CoreHome/_dataTableCell.twig", "@CoreVisualizations/_dataTableViz_htmlTable.twig", 85)->unwrap()->yield(CoreExtension::merge($context, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 85, $this->source); })())));
                        // line 86
                        yield "                            ";
                        if ((isset($context["isFilteredTotals"]) || array_key_exists("isFilteredTotals", $context) ? $context["isFilteredTotals"] : (function () { throw new RuntimeError('Variable "isFilteredTotals" does not exist.', 86, $this->source); })())) {
                            // line 87
                            yield "                                ";
                            if (($context["column"] == "label")) {
                                // line 88
                                yield "                                    <span class=\"totalsRowNote\">";
                                yield \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("General_FilteredTotalMatchingFilter"), "html", null, true);
                                yield "</span>
                                ";
                            } elseif (CoreExtension::getAttribute($this->env, $this->source,                             // line 89
($context["filteredTotalsRowContext"] ?? null), $context["column"], [], "array", true, true, false, 89)) {
                                // line 90
                                yield "                                    ";
                                $context["reportTotal"] = $this->env->getFilter('number')->getCallable()(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["filteredTotalsRowContext"]) || array_key_exists("filteredTotalsRowContext", $context) ? $context["filteredTotalsRowContext"] : (function () { throw new RuntimeError('Variable "filteredTotalsRowContext" does not exist.', 90, $this->source); })()), $context["column"], [], "array", false, false, false, 90), "reportTotal", [], "any", false, false, false, 90), 2, 0);
                                // line 91
                                yield "                                    <span class=\"totalsRowNote\">";
                                // line 92
                                if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["filteredTotalsRowContext"]) || array_key_exists("filteredTotalsRowContext", $context) ? $context["filteredTotalsRowContext"] : (function () { throw new RuntimeError('Variable "filteredTotalsRowContext" does not exist.', 92, $this->source); })()), $context["column"], [], "array", false, false, false, 92), "treatment", [], "any", false, false, false, 92) == (isset($context["additiveTreatment"]) || array_key_exists("additiveTreatment", $context) ? $context["additiveTreatment"] : (function () { throw new RuntimeError('Variable "additiveTreatment" does not exist.', 92, $this->source); })()))) {
                                    // line 93
                                    yield \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("General_FilteredTotalOfReportTotal", (isset($context["reportTotal"]) || array_key_exists("reportTotal", $context) ? $context["reportTotal"] : (function () { throw new RuntimeError('Variable "reportTotal" does not exist.', 93, $this->source); })())), "html", null, true);
                                } else {
                                    // line 95
                                    yield \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("General_FilteredTotalOverall", (isset($context["reportTotal"]) || array_key_exists("reportTotal", $context) ? $context["reportTotal"] : (function () { throw new RuntimeError('Variable "reportTotal" does not exist.', 95, $this->source); })())), "html", null, true);
                                }
                                // line 97
                                yield "</span>
                                ";
            ...
            // line 105
            if ( !(isset($context["showingEmbeddedSubtable"]) || array_key_exists("showingEmbeddedSubtable", $context) ? $context["showingEmbeddedSubtable"] : (function () { throw new RuntimeError('Variable "showingEmbeddedSubtable" does not exist.', 105, $this->source); })())) {
                // line 106
                yield "</tbody>
    </table>
    </div>";
...
{% else %}
    ...
    {%- endif -%}
        ...
        {% else %}
            ...
            {% if dataTable.getTotalsRow and properties.show_totals_row %}
                ...
                {% set rowId = 'totalsRow' %}
                {% set isFilteredTotals = isFilteredTotalsRow|default(false) %}
                {% set additiveTreatment = constant('Piwik\\\\Plugins\\\\CoreVisualizations\\\\Metrics\\\\MetricTotalsTreatment::TREATMENT_ADDITIVE') %}
                <tr class=\"{{ row.getMetadata('css_class') }} totalsRow{% if isFilteredTotals %} filteredTotalsRow{% endif %}\"
                        title=\"Total values for this table\">
                    {% for column in properties.columns_to_display %}
                        <td class=\"{% if column =='label' %}label{% else %}column{% endif %} {% if loop.first %}first{% endif %}\">
                            ...
                            {% if isFilteredTotals %}
                                {% if column == 'label' %}
                                    <span class=\"totalsRowNote\">{{ 'General_FilteredTotalMatchingFilter'|translate }}</span>
                                {% elseif filteredTotalsRowContext[column] is defined %}
                                    {% set reportTotal = filteredTotalsRowContext[column].reportTotal|number(2,0) %}
                                    <span class=\"totalsRowNote\">
                                        {%- if filteredTotalsRowContext[column].treatment == additiveTreatment -%}
                                            {{ 'General_FilteredTotalOfReportTotal'|translate(reportTotal) }}
                                        {%- else -%}
                                            {{ 'General_FilteredTotalOverall'|translate(reportTotal) }}
                                        {%- endif -%}
                                    </span>
                                {% endif %}
                            {% endif %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "/home/u348430936/domains/corentinvallet.fr/public_html/test/salonvinscharmes/analytics/matomo-latest/matomo/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable.twig");
    }
}
