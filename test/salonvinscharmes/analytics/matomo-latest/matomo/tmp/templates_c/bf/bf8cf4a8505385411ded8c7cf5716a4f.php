...
class __TwigTemplate_984ee9f014721bac5132f1203ed9217a extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["counts"]) || array_key_exists("counts", $context) ? $context["counts"] : (function () { throw new RuntimeError('Variable "counts" does not exist.', 8, $this->source); })()), "note", [], "any", false, false, false, 8), "html_attr")), "html", null, true);
                yield "
";
                // line 9
...
", "@Annotations/getEvolutionIcons.twig", "/home/u348430936/domains/corentinvallet.fr/public_html/test/salonvinscharmes/analytics/matomo-latest/matomo/plugins/Annotations/templates/getEvolutionIcons.twig");
    }
}
