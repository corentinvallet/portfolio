...
<section>
  <div class="section-inner">
    <div class="section-label fade-up">Ce qu'ils gèrent eux-mêmes</div>
    <h2 class="section-title fade-up">Un espace admin <em>simple</em>,<br>sans jamais toucher au code</h2>
    <p class="section-intro fade-up">Derrière le site, un tableau de bord privé permet à Pauline et Sylvain de faire vivre son travail au quotidien — infos pratiques, tarifs, mise à jour du bandeau d'accueil — sans dépendre de moi pour la moindre modification.</p>
    ...
    <div class="feature-grid">
      ...
      <div class="feature-card fade-up">
        <span class="feature-icon"><img src="Photos/Realisations/libellules-admin-acces.png" alt="Gestion de l'agenda dans l'admin"></span>
        <div class="feature-body">
          <div class="feature-name">Informations d'accès au gîte</div>
          <p class="feature-desc">Ajouter, réordonner ou retirer les informations pour accéder à l'éco gîte.</p>
        </div>
      </div>
    </div>
  </div>
